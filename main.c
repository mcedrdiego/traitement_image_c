...
int main(int argc, char **argv)
{
    ...
    {
        if(argc>1)
            px_Image = LireImage(argv[1], &imInfo, &imHeader);
        else
        ...
        case 1:
            ...
            EcrireImage("images/Gris.bmp", imInfo, imHeader, px_Image);
            break;
        case 2:
            Binerisation(px_Image, imInfo.Largeur * imInfo.Hauteur, 86);
            EcrireImage("images/Binaire.bmp", imInfo, imHeader, px_Image);
            break;
        case 3:
            NuancesGris(px_Image, imInfo.Largeur * imInfo.Hauteur);
            Binerisation(px_Image, imInfo.Largeur * imInfo.Hauteur, 86);
            EcrireImage("images/GrisBinaire.bmp", imInfo, imHeader, px_Image);
            break;
        case 4:
            NegatifImage(px_Image, imInfo.Largeur * imInfo.Hauteur);
            EcrireImage("images/Neg.bmp", imInfo, imHeader, px_Image);
            break;
        case 5:
            NegatifImage(px_Image, imInfo.Largeur * imInfo.Hauteur);
            NuancesGris(px_Image, imInfo.Largeur * imInfo.Hauteur);
            EcrireImage("images/NegGris.bmp", imInfo, imHeader, px_Image);
            break;
        case 6:
            NegatifImage(px_Image, imInfo.Largeur * imInfo.Hauteur);
            Binerisation(px_Image, imInfo.Largeur * imInfo.Hauteur, 86);
            EcrireImage("images/NegBinaire.bmp", imInfo, imHeader, px_Image);
            break;
        case 7:
            NegatifImage(px_Image, imInfo.Largeur * imInfo.Hauteur);
            NuancesGris(px_Image, imInfo.Largeur * imInfo.Hauteur);
            Binerisation(px_Image, imInfo.Largeur * imInfo.Hauteur, 86);
            EcrireImage("images/NegGrisBinaire.bmp", imInfo, imHeader, px_Image);
            break;
        case 8:
            px = Convolution2D(px_Image, imInfo.Largeur, imInfo.Hauteur, sy);
            EcrireImage("images/ConvSy.bmp", imInfo, imHeader, px);
            break;
        case 9:
            px = Convolution2D(px_Image, imInfo.Largeur, imInfo.Hauteur, sx);
            EcrireImage("images/ConvSx.bmp", imInfo, imHeader, px);
            free(px);
            break;
        case 10:
            px = Convolution2D(px_Image, imInfo.Largeur, imInfo.Hauteur, gauss);
            EcrireImage("images/ConvGauss.bmp", imInfo, imHeader, px);
            free(px);
            break;
        case 11:
            ajoutBruit(px_Image, imInfo.Largeur * imInfo.Hauteur, 100);
            EcrireImage("images/Bruit.bmp", imInfo, imHeader, px_Image);
            break;
        case 12:
            px = Convolution2D(px_Image, imInfo.Largeur, imInfo.Hauteur, sx);
            py = Convolution2D(px_Image, imInfo.Largeur, imInfo.Hauteur, sy);
            EcrireImage("images/Lapl.bmp", imInfo, imHeader, Laplacian(px, py, imInfo.Largeur * imInfo.Hauteur));
            free(py);
            free(px);
            break;
        case 0:
